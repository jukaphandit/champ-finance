...
const JA_REPLACEMENTS = [
  ...
  ['แผนฉุกเฉิน','緊急計画'],
  ['📜 พินัยกรรม','📜 遺言書'], ['💔 เลิกกัน','💔 別れ'],
  ['พินัยกรรม — กรณี Champ เสียชีวิต','遺言書 — Champが死亡した場合'],
  ['มูลค่า mark-to-market อัพเดทอัตโนมัติจาก Google Sheet','時価はGoogle Sheetから自動更新'],
  ['Last updated:','最終更新:'],
  ['แฟน · ญี่ปุ่น · Daikin Japan','恋人 · 日本人 · Daikin Japan'],
  ['พี่สาว · ผู้จัดการมรดก','姉 · 遺言執行人'],
  ['รวมที่ Yuko ได้รับ','Yukoの受取合計'],
  ['รวมที่พี่สาวได้รับ','姉の受取合計'],
  ['สรุปมรดกทั้งหมด','遺産合計サマリー'],
  ['มรดกรวมทั้งหมด','遺産総額'],
  ['ตัวเลขอ้างอิงจากมูลค่าปัจจุบัน','数字は現在の時価を基準にしています'],
  ['ควรปรึกษาทนายความเพื่อความถูกต้องทางกฎหมาย','法的な正確性のために弁護士に相談してください'],
  ['แผนกรณีเลิกกัน (ก่อนแต่งงาน)','別れた場合のプラン（結婚前）'],
  ['ทรัพย์สินร่วมทุน → ขายและแบ่งตามสัดส่วนที่ลงทุนจริง','共同投資資産 → 売却し、実際の投資比率で分配'],
  ['ทรัพย์สินร่วมทุน (ต้องแบ่ง)','共同投資資産（分配が必要）'],
  ['ขายบ้าน → แบ่งตามสัดส่วน Champ ฿4.4M : Yuko ฿6.6M','売却 → Champ ฿4.4M : Yuko ฿6.6Mで分配'],
  ['ขาย Condo → แบ่งตามสัดส่วน Champ ฿2.22M : Yuko ฿4.32M','売却 → Champ ฿2.22M : Yuko ฿4.32Mで分配'],
  ['สรุปหลังเลิกกัน','別れた後のサマリー'],
  ['Champ ได้รับ','Champの受取'],
  ['Yuko ได้รับคืน','Yukoへの返還'],
  ['ทรัพย์ส่วนตัว Champ','Champの個人資産'],
  ['NET WORTH Champ หลังเลิก','別れ後のChamp純資産'],
  ['รวม Yuko ได้รับคืน','Yukoへの返還合計'],
  ['ราคาขายจริงขึ้นอยู่กับตลาดอสังหาฯ ณ เวลานั้น','実際の売却価格は当時の不動産市場次第'],
